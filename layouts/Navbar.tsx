...
export default function Navbar() {
  return (
    <div className="fixed z-10 w-full pt-6">
      <Container>
        <div className="flex flex-col justify-between w-full backdrop-blur-sm rounded-2xl p-4 bg-slate-50 items-center border border-slate-200 gap-4 sm:flex-row md:gap-0">
